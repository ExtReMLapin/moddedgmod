...
local background = Color(40,40,40,150)
local front = Color(0,166,76,150)
...
function Render( entry )
			...
			cam.IgnoreZ( entry.IgnoreZ )
				...
				-- render.SetStencilZFailOperation( STENCIL_KEEP )
					...
					cam.Start2D()
						...
						surface.SetDrawColor( front )
						surface.DrawRect( 0, i+1, ScrW(),1 )
							i = i + 8
						end
	...
	render.BlurRenderTarget( rt_Blur, 0, 0, 0 )
